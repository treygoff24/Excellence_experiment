...
def compute_metric_means(per_item_csv_path: str) -> tuple[dict, dict]:
    # returns (means_by_key, counts_by_key)
...
def write_report(cfg: dict, manifest: dict, means: dict, significance: dict, costs: dict, out_path: str) -> None:
    lines: list[str] = []
...
def main():
    ...
    means, _ = compute_metric_means(per_item_csv)
    ...
    write_report(cfg, manifest, means, significance, costs, out_path)
